...
def upload_mel_file(start_seq: int, end_seq: int, session_id: str):
        ...
        with open(file_dir, "rb") as file:
            ...
            upload_file_response = requests.request(
                ...
                headers={
                    ...
                    "x-customer-uuid": "G-20240603143259-PfmhESZMqTmSNPXbCnWq",
                },
                files=files,
...
def main():
    session_id = "20240603161533_dmgey"

    upload_mel_file(0, 38, session_id)
