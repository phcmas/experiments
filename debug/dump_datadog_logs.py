...
def main():
    started_at0 = get_datetime(2024, 6, 7, 5, 0, 0)
    ended_at0 = get_datetime(2024, 6, 7, 6, 0, 0)
    result0 = get_datadog_logs(started_at0, ended_at0)
    write_file(started_at0, ended_at0)

    started_at1 = get_datetime(2024, 6, 7, 7, 0, 0)
    ended_at1 = get_datetime(2024, 6, 7, 8, 0, 0)
    result1 = get_datadog_logs(started_at1, ended_at1)

    result = result0 + result1
    write_file(started_at1, result)
